...
## График динамики размера окна TCP(снизу) и график динамики длины очереди и среденей длины очереди(сверху) при типе протокола TCP NewReno на узле s1. 

![График динамики размера окна TCP(снизу) и график динамики длины очереди и среденей длины очереди(сверху) при типе протокола TCP NewReno на узле s1](image/5.png){#fig:005 width=30%}
...
## График динамики размера окна TCP(снизу) и график динамики длины очереди и среденей длины очереди(сверху) при типе протокола TCP Vegas на узле s1.

![График динамики размера окна TCP(снизу) и график динамики длины очереди и среденей длины очереди(сверху) при типе протокола TCP Vegas на узле s1](image/6.png){#fig:007 width=30%}
