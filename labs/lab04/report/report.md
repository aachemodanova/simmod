...
![Изменение размера окна TCP на линке 1-го источника(слева) и на всех источниках(справа)](image/2.png){#fig:002 width=70%}

Также были получены графики размера длины очереди и средней длины очереди на линке (R1-R2). (рис. [-@fig:003])

![Изменение размера длины очереди(слева) и средней длиены очереди(справа) на линке (R1-R2)](image/3.png){#fig:003 width=70%}
...
```
Изменим права доступа файла gnu_plot. И запустим скрипт. (рис. [-@fig:004])

![Измение прав доступа файла gnu_plot. И запуск скрипта](image/4.png){#fig:004 width=70%}

Были получены графики изменения окна TCP на линке 1-го источника и на всех источниках. (рис. [-@fig:005])

![Изменение размера окна TCP на линке 1-го источника(сверху) и на всех источниках(снизу). GNUPlot](image/5.png){#fig:005 width=70%}

Также были получены графики размера длины очереди и средней длины очереди на линке (R1-R2). (рис. [-@fig:006])

![Изменение размера длины очереди(сверху) и средней длиены очереди(снизу) на линке (R1-R2)](image/6.png){#fig:006 width=70%}

# Выводы

Мы выполненили самостоятельное задание.
