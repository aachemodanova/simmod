...
- реализовать модель TCP/AQM в xcos[@xs];
...
![Изменение параметров блока "Continuous fix delay"](image/5.png){#fig:005 width=70%}
...
![Параметры блока "CSCOPXY"](image/8.png){#fig:008 width=70%}
...
![Динамика изменения размера TCP окна W(t)(красная) и размера очереди Q(t)(черная) в xcos. C = 1](image/10.png){#fig:010 width=70%}

![Фазовый портрет (W, Q) в xcos. C = 1](image/11.png){#fig:011 width=70%}
...
![Динамика изменения размера TCP окна W(t)(красная) и размера очереди Q(t)(черная) в xcos. C = 0.9](image/13.png){#fig:013 width=70%}

![Фазовый портрет (W, Q) в xcos. C = 0.9](image/14.png){#fig:014 width=70%}
...
![Реализация модели TCP/AQM в OpenModelica](image/15.png){#fig:015 width=70%}
...
![Динамика изменения размера TCP окна W(t)(красная) и размера очереди Q(t)(синия) в OpenModelica. C = 1](image/17.png){#fig:017 width=70%}
...
![Динамика изменения размера TCP окна W(t)(красная) и размера очереди Q(t)(синия) в OpenModelica. C = 0.9](image/20.png){#fig:020 width=70%}
