...
![Модель SIR в xcos](image/2.png){#fig:002 width=50%}
...
Для начала добавим переменную $\mu$ в Задать переменные окружения в xcos. Добавим необходимые для реализации модели блоки. 

![Модель SIR, учитывая демографические процессы, в xcos](image/14.png){#fig:014 width=50%}
